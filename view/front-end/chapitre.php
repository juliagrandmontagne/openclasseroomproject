...
<?php  foreach ($databd as $donnees) : ?>
 ...
 <form action="index.php?action=creerCommentaire " method="post" id="commentaireform" >     
         ...
         <div id="commentaire"><div id="lecommentaire"><div id="nomuser"><?php echo $donnees['nameuser']?></div><div id="messageuser"><?php echo $donnees['comment']?></div><input class="send" type="submit" id="btn-submit" value="signaler" ></div>
