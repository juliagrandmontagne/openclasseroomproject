...
<section>
		   ...
		   <section id="content">
			   ...
			   <div id="lastchapter"><h3>Le dernier chapitre (9)</h3><p><?php echo $donnees['titre-last-chapitre']?></p><?php echo $donnees['chaptirenumber']?><?php echo $donnees['chapitre-text']?>
